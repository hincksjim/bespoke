...
export declare type CreationsCreateFormInputValues = {
    prompt?: string;
    costprompt?: string;
    gender?: string;
    jewellrytype?: string;
...
export declare type CreationsCreateFormValidationValues = {
...
export declare type CreationsCreateFormOverridesProps = {
    CreationsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CreationsCreateFormProps = React.PropsWithChildren<{
    overrides?: CreationsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CreationsCreateFormInputValues) => CreationsCreateFormInputValues;
    onSuccess?: (fields: CreationsCreateFormInputValues) => void;
    onError?: (fields: CreationsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CreationsCreateFormInputValues) => CreationsCreateFormInputValues;
    onValidate?: CreationsCreateFormValidationValues;
} & React.CSSProperties>;
export default function CreationsCreateForm(props: CreationsCreateFormProps): React.ReactElement;
