...
export declare type ArtisanUpdateFormInputValues = {
    Companyname?: string;
...
export declare type ArtisanUpdateFormValidationValues = {
...
export declare type ArtisanUpdateFormOverridesProps = {
    ArtisanUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ArtisanUpdateFormProps = React.PropsWithChildren<{
    overrides?: ArtisanUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    artisan?: any;
    onSubmit?: (fields: ArtisanUpdateFormInputValues) => ArtisanUpdateFormInputValues;
    onSuccess?: (fields: ArtisanUpdateFormInputValues) => void;
    onError?: (fields: ArtisanUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ArtisanUpdateFormInputValues) => ArtisanUpdateFormInputValues;
    onValidate?: ArtisanUpdateFormValidationValues;
} & React.CSSProperties>;
export default function ArtisanUpdateForm(props: ArtisanUpdateFormProps): React.ReactElement;
