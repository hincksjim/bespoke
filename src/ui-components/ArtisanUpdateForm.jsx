...
import { getArtisan, listContacts } from "../graphql/queries";
import { updateArtisan, updateContact } from "../graphql/mutations";
...
export default function ArtisanUpdateForm(props) {
  const {
    id: idProp,
    artisan: artisanModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = artisanRecord
      ? { ...initialValues, ...artisanRecord, Contacts: linkedContacts }
      : initialValues;
    setCompanyname(cleanValues.Companyname);
    setCompanyaddress(cleanValues.Companyaddress);
    setCompanypostcode(cleanValues.Companypostcode);
    setIsactive(cleanValues.isactive);
    setPhone(cleanValues.phone);
    setEmail(cleanValues.email);
    setInterestedinMale(cleanValues.interestedinMale);
    setInterestedinfemale(cleanValues.interestedinfemale);
    setInterestedinallgender(cleanValues.interestedinallgender);
    setInterestedinrings(cleanValues.interestedinrings);
    setInterestedinnecklaces(cleanValues.interestedinnecklaces);
    setInterestedinbraclets(cleanValues.interestedinbraclets);
    setInterestedinearrings(cleanValues.interestedinearrings);
    setInterestedinchains(cleanValues.interestedinchains);
    setInterestedincufflinks(cleanValues.interestedincufflinks);
    setInterstedinaljewellrytypes(cleanValues.interstedinaljewellrytypes);
    setAgreedtoterms(cleanValues.agreedtoterms);
    setIpaddress(cleanValues.ipaddress);
    setCountry(cleanValues.Country);
    setCurrency(cleanValues.Currency);
    setAgreedtimestamp(cleanValues.agreedtimestamp);
    setContacts(cleanValues.Contacts ?? []);
    setCurrentContactsValue(undefined);
    setCurrentContactsDisplayValue("");
    setErrors({});
  };
  const [artisanRecord, setArtisanRecord] = React.useState(artisanModelProp);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getArtisan.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getArtisan
        : artisanModelProp;
      ...
      setArtisanRecord(record);
    };
    queryData();
  }, [idProp, artisanModelProp]);
  React.useEffect(resetStateValues, [artisanRecord, linkedContacts]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          phone: phone ?? null,
          email: email ?? null,
          interestedinMale: interestedinMale ?? null,
          interestedinfemale: interestedinfemale ?? null,
          interestedinallgender: interestedinallgender ?? null,
          interestedinrings: interestedinrings ?? null,
          interestedinnecklaces: interestedinnecklaces ?? null,
          interestedinbraclets: interestedinbraclets ?? null,
          interestedinearrings: interestedinearrings ?? null,
          interestedinchains: interestedinchains ?? null,
          interestedincufflinks: interestedincufflinks ?? null,
          interstedinaljewellrytypes: interstedinaljewellrytypes ?? null,
          agreedtoterms: agreedtoterms ?? null,
          ipaddress: ipaddress ?? null,
          Country: Country ?? null,
          Currency: Currency ?? null,
          agreedtimestamp: agreedtimestamp ?? null,
        ...
        try {
          ...
          contactsToUnLink.forEach((original) => {
            if (!canUnlinkContacts) {
              throw Error(
                `Contact ${original.id} cannot be unlinked from Artisan because artisanID is a required field.`
              );
            }
            promises.push(
              client.graphql({
          ...
          const modelFieldsToSave = {
            ...
            Companyaddress: modelFields.Companyaddress ?? null,
            Companypostcode: modelFields.Companypostcode ?? null,
            isactive: modelFields.isactive ?? null,
            phone: modelFields.phone ?? null,
            email: modelFields.email ?? null,
            interestedinMale: modelFields.interestedinMale ?? null,
            interestedinfemale: modelFields.interestedinfemale ?? null,
            interestedinallgender: modelFields.interestedinallgender ?? null,
            interestedinrings: modelFields.interestedinrings ?? null,
            interestedinnecklaces: modelFields.interestedinnecklaces ?? null,
            interestedinbraclets: modelFields.interestedinbraclets ?? null,
            interestedinearrings: modelFields.interestedinearrings ?? null,
            interestedinchains: modelFields.interestedinchains ?? null,
            interestedincufflinks: modelFields.interestedincufflinks ?? null,
            interstedinaljewellrytypes:
              modelFields.interstedinaljewellrytypes ?? null,
            agreedtoterms: modelFields.agreedtoterms ?? null,
            ipaddress: modelFields.ipaddress ?? null,
            Country: modelFields.Country ?? null,
            Currency: modelFields.Currency ?? null,
            agreedtimestamp: modelFields.agreedtimestamp ?? null,
          };
          promises.push(
            client.graphql({
              query: updateArtisan.replaceAll("__typename", ""),
              variables: {
                input: {
                  id: artisanRecord.id,
                  ...modelFieldsToSave,
      ...
      {...getOverrideProps(overrides, "ArtisanUpdateForm")}
      {...rest}
    >
      <TextField
        label="Companyname"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || artisanModelProp)}
