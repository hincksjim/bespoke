...
import { createClient, updateCreations } from "../graphql/mutations";
...
export default function ClientCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCredits(initialValues.credits);
    ...
    setIsArtisan(initialValues.IsArtisan);
    setPaywall(initialValues.Paywall);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const promises = [];
          promises.push(
            ...clientID.reduce((promises, original) => {
              promises.push(
                client.graphql({
